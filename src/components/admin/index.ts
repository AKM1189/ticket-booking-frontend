...
export { default as ScreenManagement } from "./screen/ScreenManagement";
...
export { default as SeatLayoutViewer } from "./screen/SeatLayoutViewer";
export { default as TheatreManagement } from "./theatre/TheatreManagement";
