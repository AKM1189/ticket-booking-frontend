...
export { default as ScreenManagement } from "./screens/ScreenManagement";
...
export { default as SeatLayoutViewer } from "./screens/SeatLayoutViewer";
export { default as TheatreManagement } from "./theatres/TheatreManagement";
