...
const MovieCard = ({ movie }: { movie: MovieType }) => {
  return (
    <div className="bg-surface group">
      <div className="relative min-w-[250px] h-[400px] rounded-t-lg overflow-hidden">
        <Image
          src={movie.posterUrl}
      ...
      <div className="p-5 flex justify-between items-center">
        <span>
          <div className="text-text text-xl font-semibold mb-1">
            {movie.name}
          </div>
        ...
        <Button size="sm" className="!min-w-[110px] !text-sm !px-3">
          Book Ticket
        </Button>
      </div>
    </div>
